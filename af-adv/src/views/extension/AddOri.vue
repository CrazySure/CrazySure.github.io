        ...
        <el-card class="ori-main">
            ...
            >
                ...
                <el-form-item label="曝光监测地址" prop="exposure_link">
                    <el-input v-model="addOriForm.exposure_link"></el-input>
                </el-form-item>
                <el-form-item label="点击监测地址" prop="click_link">
                    <el-input v-model="addOriForm.click_link"></el-input>
                </el-form-item>
                <el-form-item>
                        ...
                        <div class="public-box">
                            <div class="android move-area" v-el-drag-dialog v-el-drag-dialog-video v-el-drag-dialog-text>
                                ...
                                <div class="drag-move" >
                                    <div  class="preview-img preview">
                                        <span class="drag-img"></span>
                                        <img  :src="addOriForm.image_url" alt  />
                                    </div>
                                </div>
                                </div>
                                <div class="drag-move" >
...
export default {
    ...
    methods: {
        ...
        //点击确定按钮提交更改的数据
        oriEditData() {
            this.$refs["addOriFormRef"].validate(valid => {
                if (valid) {
                    //发起数据请求
                    oriEditDataTable(this.addOriForm.plan_id).then(() => {
